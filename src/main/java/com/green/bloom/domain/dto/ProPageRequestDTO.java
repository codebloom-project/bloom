...
@Getter
public class ProPageRequestDTO {
	 ...
	 */
	public static ProPageRequestDTO create(int page,  int limit, int rowCount) {
		return new ProPageRequestDTO(page, limit, rowCount);
	}
	 ...
	 * @return from(출력되는 페이지 시작번호), to(출력되는 페이지 마직막 번호), tot(페이지 총 개수)
	 */
	public static ProPageRequestDTO create(int page,  int limit, int rowCount, int RANGE) {
		return new ProPageRequestDTO(page, limit, rowCount, RANGE);
	}
	
	private ProPageRequestDTO(int page,  int limit, int rowCount, int RANGE){
	...
	private ProPageRequestDTO(int page,  int limit, int rowCount){
