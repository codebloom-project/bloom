package com.green.bloom.weather.controller.longWeek.weatherMidLandFcst;
...
@Controller
public class WeatherMidandFcstkController {
	...
	//중기육상예보 조회
	@GetMapping("/data/WeatherMidandFcstk")
	public String getMidFcst(WeatherMidFcstkInfo dto, Model model) throws IOException{
        ...
        model.addAttribute("midfandcstk", result.getResponse().getBody().getItems().getItem());
