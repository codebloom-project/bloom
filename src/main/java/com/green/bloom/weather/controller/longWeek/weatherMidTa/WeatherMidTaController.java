package com.green.bloom.weather.controller.longWeek.weatherMidTa;
...
import com.green.bloom.weather.controller.longWeek.weatherMidFcstk.WeatherMidFcstkInfo;
import com.green.bloom.weather.dto.longWeek.weatherMidFcstk.WeatherMidFcstkResponseDTO;

@Controller
public class WeatherMidTaController {
	...
	public String getMidFcst(WeatherMidFcstkInfo dto, Model model) throws IOException{
        ...
        urlBuilder.append("&" + URLEncoder.encode("regId","UTF-8") + "=" + URLEncoder.encode("11B10101", "UTF-8")); //
        ...
        model.addAttribute("midta", result.getResponse().getBody().getItems().getItem());
